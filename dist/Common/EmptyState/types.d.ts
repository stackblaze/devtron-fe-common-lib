...
export type GenericFilterEmptyStateProps = Omit<GenericEmptyStateType, 'image' | 'title' | 'subTitle' | 'isButtonAvailable' | 'renderButton'> & Partial<Pick<GenericEmptyStateType, 'title' | 'subTitle'>> & ({
    /**
