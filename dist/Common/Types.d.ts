...
export declare enum DeploymentNodeType {
    PRECD = "PRECD",
    CD = "CD",
    POSTCD = "POSTCD",
    APPROVAL = "APPROVAL"
}
export declare enum ManualApprovalType {
    specific = "SPECIFIC",
    any = "ANY",
...
export declare enum MaterialDataSource {
    EXTERNAL = "ext"
}
export declare enum ImagePromotionRuntimeState {
    AWAITING = "AWAITING",
    PROMOTED = "PROMOTED",
    CANCELLED = "CANCELLED",
    STALE = "STALE"
...
export interface CommonNodeAttr extends Pick<MandatoryPluginBaseStateType, 'isTriggerBlocked' | 'pluginBlockState'> {
    ...
    rollbackMaterialList?: any[];
    linkedCount?: number;
    deploymentStrategy?: string;
    height: number;
    width: number;
    preNode?: CommonNodeAttr;
    postNode?: CommonNodeAttr;
    stageIndex?: number;
    sourceNodes?: Array<CommonNodeAttr>;
...
export declare enum AddCDPositions {
    LEFT = "left",
    RIGHT = "right"
}
...
export declare enum AddPipelineType {
