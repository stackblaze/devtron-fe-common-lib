 ...
 */
type ValidationRequired = boolean | {
    value: boolean;
    message: string;
};
/**
 ...
 */
export type UseFormValidations<T extends {}> = ((formData: T) => Partial<Record<keyof T, UseFormValidation>>) | Partial<Record<keyof T, UseFormValidation>>;
/**
