...
export type DynamicDataTableCellPropsMap = {
    [DynamicDataTableRowDataType.TEXT]: Omit<ResizableTagTextAreaProps, 'id' | 'className' | 'minHeight' | 'maxHeight' | 'value' | 'onChange' | 'disabled' | 'disableOnBlurResizeToMinHeight' | 'refVar' | 'dependentRef' | 'dependentRefs'>;
    [DynamicDataTableRowDataType.DROPDOWN]: Omit<SelectPickerProps<string, false>, 'inputId' | 'value' | 'onChange' | 'fullWidth' | 'isDisabled'>;
    [DynamicDataTableRowDataType.SELECT_TEXT]: Omit<SelectPickerTextAreaProps, 'inputId' | 'value' | 'onChange' | 'fullWidth' | 'isDisabled' | 'variant' | 'formatCreateLabel' | 'minHeight' | 'maxHeight' | 'refVar' | 'dependentRefs'>;
