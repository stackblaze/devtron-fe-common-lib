...
export interface CIMaterialType extends Pick<CIMaterialDTO, 'id' | 'gitMaterialId' | 'gitMaterialName' | 'type' | 'value' | 'active' | 'lastFetchTime'>, CIMaterialMetaType {
...
export declare enum AppEnvDeploymentConfigType {
...
export declare enum DraftAction {
    Add = 1,
    Update = 2,
    Delete = 3
}
...
export declare enum EnvResourceType {
    ConfigMap = "configmap",
    Secret = "secrets",
    DeploymentTemplate = "deployment-template",
    Manifest = "manifest",
