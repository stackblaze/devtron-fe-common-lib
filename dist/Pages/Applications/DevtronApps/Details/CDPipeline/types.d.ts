...
export interface Environment extends Pick<EnvListMinDTO, 'id' | 'active' | 'namespace' | 'isClusterCdActive'>, Partial<Pick<EnvListMinDTO, 'isVirtualEnvironment' | 'allowedDeploymentTypes' | 'description' | 'isDigestEnforcedForEnv'>> {
    name: string;
    clusterName: string;
    clusterId: string;
}
