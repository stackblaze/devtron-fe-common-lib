...
export type UserRoleGroupsTableProps = {
    ...
    handleStatusUpdate: (id: UserRoleGroup['id'], updatedStatus: UserRoleGroup['status'], updatedTimeToLive: UserRoleGroup['timeToLive']) => void;
    disableStatusComponent?: boolean;
});
export type UserRoleGroupTableRow = UserRoleGroup & Pick<UserRoleGroupsTableProps, 'disableStatusComponent' | 'handleStatusUpdate' | 'handleDelete' | 'statusComponent' | 'showStatus'> & {
